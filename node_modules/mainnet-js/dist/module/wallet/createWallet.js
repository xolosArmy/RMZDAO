 ...
 */
export async function namedWalletExists(body) {
 ...
 */
export async function namedWallet(name, walletType, networkType) {
 ...
 * @returns A promise to a new wallet object
 */
export async function replaceNamedWallet(body) {
    let wallet;
    const walletType = body.type ? body.type : "seed";
    const networkType = body.network ? body.network : "mainnet";
    const name = body.name;
 ...
 * @returns A promise to a new wallet object
 */
export async function createSlpWallet(body) {
    let wallet;
    let walletType = body.type ? body.type : "seed";
    let networkType = body.network ? body.network : "mainnet";
    // Named wallets are saved in the database
 ...
 */
export async function createWalletResponse(walletRequest) {
 ...
 * @returns A new wallet object
 */
export async function createSlpWalletResponse(walletRequest) {
