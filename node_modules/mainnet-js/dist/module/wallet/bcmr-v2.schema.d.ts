 ...
 * a token category.
 */
export declare type NftCategoryField = {
    [identifier: string]: {
        /**
 ...
 * token category.
 */
export declare type NftCategory = {
    /**
     * A string describing how this identity uses NFTs (for use in user
 ...
 */
export declare type ChainSnapshot = Omit<IdentitySnapshot, "migrated" | "token"> & {
    /**
 ...
 * ```
 */
export declare type RegistryTimestampKeyedValues<T> = {
    [timestamp: string]: T;
};
/**
 ...
 */
export declare type ChainHistory = RegistryTimestampKeyedValues<ChainSnapshot>;
/**
 ...
 */
export declare type IdentityHistory = RegistryTimestampKeyedValues<IdentitySnapshot>;
export declare type OffChainRegistryIdentity = Pick<IdentitySnapshot, "name" | "description" | "uris" | "tags" | "extensions">;
/**
...
//# sourceMappingURL=bcmr-v2.schema.d.ts.map