import type { AuthenticationProgramCommon, AuthenticationProgramStateCommon, AuthenticationProgramStateMinimum, ResolvedTransactionCommon } from '../lib.js';
/**
 ...
 */
export type InstructionSet<ResolvedTransaction, AuthenticationProgram, ProgramState> = {
    /**
     ...
     */
    evaluate: (program: AuthenticationProgram, stateEvaluate: (state: ProgramState) => ProgramState) => ProgramState;
    /**
     ...
     */
    verify: (resolvedTransaction: ResolvedTransaction, evaluate: (program: AuthenticationProgram) => ProgramState, success: (state: ProgramState) => string | true) => string | true;
};
/**
 * A set of pure-functions allowing transactions and their authentication
 * programs to be evaluated and inspected.
 */
export type AuthenticationVirtualMachine<ResolvedTransaction, AuthenticationProgram, ProgramState> = {
    /**
 ...
 */
export declare const createAuthenticationVirtualMachine: <ResolvedTransaction = ResolvedTransactionCommon, AuthenticationProgram = AuthenticationProgramCommon, ProgramState extends AuthenticationProgramStateMinimum = AuthenticationProgramStateCommon>(instructionSet: InstructionSet<ResolvedTransaction, AuthenticationProgram, ProgramState>) => AuthenticationVirtualMachine<ResolvedTransaction, AuthenticationProgram, ProgramState>;
