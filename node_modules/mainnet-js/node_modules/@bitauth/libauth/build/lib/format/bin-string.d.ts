 ...
 */
export declare const binStringToBin: (binaryDigits: string) => Uint8Array;
/**
 ...
 */
export declare const binToBinString: (bytes: Uint8Array) => string;
/**
 ...
 */
export declare const isBinString: (maybeBinString: string) => boolean;
//# sourceMappingURL=bin-string.d.ts.map