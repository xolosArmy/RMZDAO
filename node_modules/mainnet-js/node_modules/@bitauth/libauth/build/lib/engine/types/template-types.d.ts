 ...
 */
export type AuthenticationVirtualMachineIdentifier = 'BCH_2020_05' | 'BCH_2021_05' | 'BCH_2022_05' | 'BCH_2023_05' | 'BCH_SPEC' | 'BSV_2020_02' | 'BSV_SPEC' | 'BTC_2017_08' | 'BTC_SPEC' | 'XEC_2020_05' | 'XEC_SPEC';
/**
 ...
 */
export type WalletTemplateScenarioBytecode = string | {
    /**
...
export type WalletTemplateScenarioOutput<IsSourceOutput extends boolean> = {
     ...
     */
    readonly lockingBytecode?: IsSourceOutput extends true ? WalletTemplateScenarioBytecode | ['slot'] : WalletTemplateScenarioBytecode;
    /**
 ...
 * transaction.
 */
export type WalletTemplateScenarioTransactionOutput = WalletTemplateScenarioOutput<false>;
/**
 * A source output used by a wallet template scenario.
 */
export type WalletTemplateScenarioSourceOutput = WalletTemplateScenarioOutput<true>;
/**
...
export type WalletTemplateHdKey = WalletTemplateKeyBase & WalletTemplateVariableBase & {
    /**
...
export type WalletTemplateKey = WalletTemplateKeyBase & WalletTemplateVariableBase & {
    /**
...
export type WalletTemplateVariable = WalletTemplateAddressData | WalletTemplateHdKey | WalletTemplateKey | WalletTemplateWalletData;
