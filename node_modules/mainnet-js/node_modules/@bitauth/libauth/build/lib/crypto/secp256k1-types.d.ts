...
export type Secp256k1 = {
     ...
     * number
     */
    recoverPublicKeyCompressed: (signature: Uint8Array, recoveryId: RecoveryId, messageHash: Uint8Array) => Uint8Array | string;
    /**
     ...
     * number
     */
    recoverPublicKeyUncompressed: (signature: Uint8Array, recoveryId: RecoveryId, messageHash: Uint8Array) => Uint8Array | string;
    /**
