import { pbkdf2HmacSha512 as internalPbkdf2HmacSha512, sha512 as internalSha512, sha256, } from '../crypto/crypto.js';
 ...
 */
export const deriveSeedFromBip39Mnemonic = (mnemonic, passphrase, crypto = {
 ...
 */
export const deriveHdPrivateNodeFromBip39Mnemonic = (mnemonic, passphrase, crypto = {
    pbkdf2HmacSha512: internalPbkdf2HmacSha512,
    sha512: internalSha512,
}, hmacSha512Key) => deriveHdPrivateNodeFromSeed(deriveSeedFromBip39Mnemonic(mnemonic, passphrase, crypto), undefined, crypto, hmacSha512Key);
/**
 ...
 */
export const generateBip39MnemonicNonStandard = (wordList, entropyLength = 16 /* Bip39.minEntropyBytes */) => {
    if (!isValidBip39WordList(wordList)) {
        return formatError(Bip39Error.invalidWordListLength, `Word list length: ${wordList.length}.`);
    }
