...
import { base58ToBin, BaseConversionError, bigIntToBinUint256BEClamped, binToBase58, binToBigIntUint256BE, flattenBinArray, numberToBinUint32BE, utf8ToBin, } from '../format/format.js';
/**
 ...
 */
export const deriveHdPrivateNodeFromSeed = (seed, assumeValidity, crypto = {
 ...
 * to use
 */
export const encodeHdPrivateKeyPayload = (keyParameters) => {
...
export const deriveHdPath = (node, path, crypto = {
    ...
    return (isPrivateDerivation
        ? indexes.reduce((result, nextIndex) => typeof result === 'string'
            ? result
            : deriveHdPrivateNodeChild(result, nextIndex, crypto), node)
        : indexes.reduce((result, nextIndex) => typeof result === 'string'
            ? result
            : deriveHdPublicNodeChild(result, nextIndex, crypto), node));
};
