import type { AuthenticationProgramCommon, AuthenticationVirtualMachine, CompilationContextBCH, CompilationResult, CompilationResultError, Ripemd160, Secp256k1, Sha256, Sha512, WalletTemplateScenario, WalletTemplateVariable } from '../lib.js';
 ...
 */
export type CompilerOperationError = CompilerOperationErrorFatal | CompilerOperationErrorRecoverable;
/**
 * A successful compiler operation result.
 */
export type CompilerOperationSuccess = CompilerOperationSuccessGeneric | CompilerOperationSuccessSignatureType;
 ...
 */
export type CompilerOperationSuccessSignatureType = CompilerOperationSuccessDataSignature | CompilerOperationSuccessSignature;
/**
 * The result of a successful `signature` compiler operation.
 */
export type CompilerOperationSuccessSignature = CompilerOperationSuccessGeneric & {
    signature: {
        /**
 ...
 */
export type CompilerOperationSuccessDataSignature = CompilerOperationSuccessGeneric & {
    signature: {
        /**
...
export type CompilerOperationResult<CanBeSkipped extends boolean = false> = CanBeSkipped extends true ? CompilerOperationError | CompilerOperationSkip | CompilerOperationSuccess : CompilerOperationError | CompilerOperationSuccess;
/**
 ...
 * the compiler
 */
export type CompilerOperation<CompilationContext = unknown, CanBeSkipped extends boolean = false, Data extends CompilationData<CompilationContext> = CompilationData<CompilationContext>, Configuration extends AnyCompilerConfiguration<CompilationContext> = AnyCompilerConfiguration<CompilationContext>> = (identifier: string, data: Data, configuration: Configuration) => CompilerOperationResult<CanBeSkipped>;
 ...
 * signed.
 */
export type CompilerOperationsSigningSerializationFull = 'full_all_outputs_all_utxos' | 'full_all_outputs_single_input_INVALID_all_utxos' | 'full_all_outputs_single_input' | 'full_all_outputs' | 'full_corresponding_output_all_utxos' | 'full_corresponding_output_single_input_INVALID_all_utxos' | 'full_corresponding_output_single_input' | 'full_corresponding_output' | 'full_default' | 'full_no_outputs_all_utxos' | 'full_no_outputs_single_input_INVALID_all_utxos' | 'full_no_outputs_single_input' | 'full_no_outputs';
/**
 ...
 */
export type CompilerOperationsSigningSerializationComponent = 'corresponding_output_hash' | 'corresponding_output' | 'covered_bytecode_length' | 'covered_bytecode' | 'locktime' | 'outpoint_index' | 'outpoint_transaction_hash' | 'output_value' | 'sequence_number' | 'transaction_outpoints_hash' | 'transaction_outpoints' | 'transaction_outputs_hash' | 'transaction_outputs' | 'transaction_sequence_numbers_hash' | 'transaction_sequence_numbers' | 'version';
/**
 * Valid identifiers describing the various full and partial signing
 * serializations available to the compiler.
 */
export type CompilerOperationsSigningSerializationCommon = CompilerOperationsSigningSerializationComponent | CompilerOperationsSigningSerializationFull;
/**
...
export type CompilerConfiguration<CompilationContext = unknown, CompilerKeyOperations extends string | false = CompilerOperationsKeysCommon, CompilerSigningSerializationOperations extends string | false = CompilerOperationsSigningSerializationCommon, CompilerAddressDataOperations extends string | false = false, CompilerWalletDataOperations extends string | false = false, CompilerCurrentBlockHeightOperations extends string | false = false, CompilerCurrentBlockTimeOperations extends string | false = false> = {
     ...
     * for details.
     */
    createAuthenticationProgram?: ((evaluationBytecode: Uint8Array) => any) | undefined;
    /**
    ...
    operations?: {
        ...
        } : CompilerOperation<CompilationContext>) | undefined;
 ...
 * multiple operations.
 */
export type AnyCompilerConfiguration<CompilationContext> = CompilerConfiguration<CompilationContext, string | false, string | false, string | false, string | false, string | false, string | false>;
/**
 * Any compiler configuration where the type of the `operations` value is
 * irrelevant.
 */
export type AnyCompilerConfigurationIgnoreOperations<CompilationContext = CompilationContextBCH> = Omit<AnyCompilerConfiguration<CompilationContext>, 'operations'>;
export type BytecodeGenerationResult<ProgramState> = CompilationResultError<ProgramState> | {
    bytecode: Uint8Array;
    success: true;
};
/**
 ...
 */
export type Compiler<CompilationContext, Configuration extends AnyCompilerConfiguration<CompilationContext>, ProgramState> = {
    configuration: Configuration;
    /**
     * Generate the bytecode for the given script and compilation data.
     */
    generateBytecode: <Debug extends boolean>({ data, debug, scriptId, }: {
        /**
     ...
     * unlocking scripts).
     */
    generateScenario: <Debug extends boolean>({ debug, lockingScriptId, scenarioId, unlockingScriptId, }: {
        /**
         * Enable compilation debugging information (default: `false`)
         */
        debug?: Debug;
