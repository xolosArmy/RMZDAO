 ...
 */
export type AuthenticationInstruction = AuthenticationInstructionOperation | AuthenticationInstructionPush;
/**
 ...
 * can be read).
 */
export type AuthenticationInstructionMalformed = AuthenticationInstructionPushMalformedData | AuthenticationInstructionPushMalformedLength;
/**
 ...
 */
export type AuthenticationInstructionMaybeMalformed = AuthenticationInstruction | AuthenticationInstructionMalformed;
 ...
 * instruction.
 */
export type AuthenticationInstructionsMaybeMalformed = AuthenticationInstructions | AuthenticationInstructionsMalformed;
export {};
