import type { AnyCompilerConfiguration, Compiler, TransactionGenerationAttempt, TransactionTemplateEstimated } from '../lib.js';
/**
 ...
 */
export declare const estimateTransaction: <CompilerType extends Compiler<unknown, AnyCompilerConfiguration<unknown>, unknown>, ProgramState>(template: TransactionTemplateEstimated<CompilerType>) => TransactionGenerationAttempt<ProgramState>;
